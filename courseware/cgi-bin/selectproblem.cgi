...
<table border="0" width="665" cellpadding="10" cellspacing="0">
  <tr> 
    ...
    <td colspan="12" width="605"><font face="Arial, Helvetica, sans-serif" color="#999999" size="3">
	<b>Select a problem to work on</b><br>
	<font color="#666666" size="2">You can only work on one problem at a time. To work on another problem, return
	to this screen and select another. If you have already worked on the problem you select, 
	it will automatically load into DBN.
	</font></font><br>
	</td>
    </tr>
END_of_problem1
