...
if ($mode==$MODE_BADLOGIN)   { $message_text = gold('登録名あるいはパスワードが正しくありません。<br><br>') }
...
<table border="0" cellpadding="10" cellspacing="0" width="665">
  <tr> 
    ...
    <td width="605" height="100" valign="top" align="left">$message_text
      ...
      コースに登録されている名前とパスワードを入力し'開始'ボタンを押して下さい。
      <br>
      <br>
      ...
      <br>
      <br>  
      <input type="submit" value="開始" name="view">
      </form>
      </font>
    </td>
  </tr>
...
print<<END_of_nocourse;
    <table border="0" cellpadding="10" cellspacing="0" width="665">
     <tr> 
	  ...
	  <font size="2"  color="#666666">
	  <!--<font color="CC9900"><b>コース名をお知らせください</b></font>-->
	  <br>
	  <br>受講するコース名を選んで'次に進む'ボタンを押して下さい。<br>
	  <form method=post>
	  <SELECT name="course">
	     <OPTION value="" selected>コースを選ぶ</OPTION>
	     $options
	  </SELECT>	  
