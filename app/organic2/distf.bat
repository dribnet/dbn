...
rem --- this includes the 'DbnFancy' version of the dbn app

rm -f dbn.zip
zip -rq dbn.zip run.bat runf.bat bin\*.dll bin\*.exe lib\*.gif lib\*.properties lib\*.jar lib\security\java.security lib\*.py lib\pawt\*.py
